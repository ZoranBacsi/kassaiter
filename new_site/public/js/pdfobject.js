...
(function (root, factory) {
    ...
    embed = function(url, targetSelector, options){
        ...
        var id = (options.id && typeof options.id === "string") ? "id='" + options.id + "'" : "",
            ...
            fallbackHTML = "",
            pdfOpenFragment = "",
            fallbackHTML_default = "<p class='alert alert-danger'>A Böngészője sajnos nem támogatja a beépített PDF olvasókat, kérjük kattintson a megnyitáshoz. <a href='[url]'>PDF Megnyitása</a></p>";
